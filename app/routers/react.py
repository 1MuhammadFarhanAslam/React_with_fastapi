...
nginx_url = "http://38.242.218.205:8000/" 
...
@router.get("/", tags=["Frontend_Signup/Login"], response_class=HTMLResponse)
async def read_root():
    html_content = """
    <html>
    <head>
    ...
    <p>This is the first version of the API. Please visit <a href="https://api.bittaudio.ai/docs">https://api.bittaudio.ai/docs</a> to view the API documentation.</p>
    </body>
    </html>
    """
