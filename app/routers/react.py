...
async def read_root():
    ...
    <p>This is the first version of the API. Please visit <a href="http://193.29.187.81:8000/docs">http://193.29.187.81:8000/docs</a> to view the API documentation.</p>
    </body>
    </html>
    """
